...
(defun update-game (world)
  ...
  (cond ((sdl:get-key-state :sdl-key-w)
	 ...
	 (cond ((eq (nth (+ (round (gethash 'companion-x world)) 1) (nth (+ (round (gethash 'companion-y world)) 0) (gethash 'cells world))) 0)
		(setf (gethash 'companion-y world) (- (gethash 'companion-y world) 0.2))))))	 
  (cond ((sdl:get-key-state :sdl-key-s)
	 (cond ((eq (nth (+ (round (gethash 'player-x world)) 1) (nth (+ (round (gethash 'player-y world)) 2) (gethash 'cells world))) 0)
		(setf (gethash 'player-y world) (+ (gethash 'player-y world) 0.2))))
	 (cond ((eq (nth (+ (round (gethash 'companion-x world)) 1) (nth (+ (round (gethash 'companion-y world)) 2) (gethash 'cells world))) 0)
		(setf (gethash 'companion-y world) (+ (gethash 'companion-y world) 0.2))))))
  (cond ((sdl:get-key-state :sdl-key-a)
	 ...
	 (cond ((eq (nth (+ (round (gethash 'companion-x world)) 0) (nth (+ (round (gethash 'companion-y world)) 1) (gethash 'cells world))) 0)
		(setf (gethash 'companion-x world) (- (gethash 'companion-x world) 0.2))))))
  (cond ((sdl:get-key-state :sdl-key-d)
	 (cond ((eq (nth (+ (round (gethash 'player-x world)) 2) (nth (+ (round (gethash 'player-y world)) 1) (gethash 'cells world))) 0)
		(setf (gethash 'player-x world) (+ (gethash 'player-x world) 0.2))))
	 (cond ((eq (nth (+ (round (gethash 'companion-x world)) 2) (nth (+ (round (gethash 'companion-y world)) 1) (gethash 'cells world))) 0)
		(setf (gethash 'companion-x world) (+ (gethash 'companion-x world) 0.2))))))
  ...
  (if (> (gethash 'companion-y world) (- (gethash 'unscaled-height world) 1))
      (setf (gethash 'companion-y world) (- (gethash 'unscaled-height world) 1)))
  (if (< (gethash 'companion-y world) 0)
      (setf (gethash 'companion-y world) 0))
  (if (> (gethash 'companion-x world) (- (gethash 'unscaled-width world) 1))
      (setf (gethash 'companion-x world) (- (gethash 'unscaled-width world) 1)))
  (if (< (gethash 'companion-x world) 0)
      (setf (gethash 'companion-x world) 0))
